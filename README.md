...
```yaml
      - run: |
          curl -fsSL https://github.com/murtazaozdemir/cleartoship/releases/download/v0.13.12/cleartoship.mjs -o cleartoship.mjs
...
jobs:
  preflight:
    ...
    steps:
      ...
      - uses: murtazaozdemir/cleartoship@v0.13.12
        with:
          fail-on: critical
          comment: true
```
...
declares, so `@v0.13.12` runs ClearToShip 0.13.12 and pinning the ref pins the
